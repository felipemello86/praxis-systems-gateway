// Ícones próprios (sem emoji, sem lib externa) — formas simples desenhadas
// à mão em SVG, no mesmo estilo outline (stroke, sem preenchimento) pra
// ficar consistente entre os 4 botões do hub.
