    ...
    return (
      ...
      >
        <h1 style={{ fontSize: 20, fontWeight: 700, margin: 0 }}>
          Entre em um dos módulos primeiro
        </h1>
        <p style={{ color: "#6e6e73", margin: 0, maxWidth: 320 }}>
          As configurações da conta ficam disponíveis depois que você faz login em algum módulo.
        </p>
